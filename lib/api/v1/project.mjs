...
import { delete_project_route } from './project/delete.mjs';
...
const projects = [list, info, import_project, refresh, delete_project_route];

export { projects, list, info, import_project, refresh, delete_project_route };
