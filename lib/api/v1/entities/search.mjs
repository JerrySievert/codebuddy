...
/**
 * @fileoverview Entities search API route.
 * Provides fuzzy search for entities by name across all types.
 * @module lib/api/v1/entities/search
 */
...
/**
 * Handler for GET /api/v1/entities/search - search entities by name.
 * @param {Object} request - Hapi request object
 * @param {Object} request.query - Query parameters
 * @param {string} request.query.name - Entity name to search for (required)
...
const search_handler = async (request, h) => {
  const { name, project, filename, type, limit = 10 } = request.query;
