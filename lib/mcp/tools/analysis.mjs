 ...
 */
export const analysis_dashboard_handler = async ({ project }) => {
 ...
 */
export const analysis_dead_code_handler = async ({ project }) => {
  const project_id = await get_project_id(project);
 ...
 */
export const analysis_dependencies_handler = async ({ project }) => {
  const project_id = await get_project_id(project);
 ...
 */
export const analysis_security_handler = async ({ project }) => {
  const project_id = await get_project_id(project);
 ...
 */
export const analysis_metrics_handler = async ({ project }) => {
  const project_id = await get_project_id(project);
 ...
 */
export const analysis_code_smells_handler = async ({ project }) => {
  const project_id = await get_project_id(project);
 ...
 */
export const analysis_types_handler = async ({ project }) => {
  const project_id = await get_project_id(project);
 ...
 */
export const analysis_api_surface_handler = async ({ project }) => {
  const project_id = await get_project_id(project);
 ...
 */
export const analysis_documentation_handler = async ({ project }) => {
  const project_id = await get_project_id(project);
 ...
 */
export const analysis_scope_handler = async ({ project }) => {
  const project_id = await get_project_id(project);
 ...
 */
export const analysis_concurrency_handler = async ({ project }) => {
  const project_id = await get_project_id(project);
 ...
 */
export const analysis_resources_handler = async ({ project }) => {
  const project_id = await get_project_id(project);
 ...
 */
export const analysis_naming_handler = async ({ project }) => {
  const project_id = await get_project_id(project);
 ...
 */
export const analysis_readability_handler = async ({ project }) => {
  const project_id = await get_project_id(project);
 ...
 */
export const analysis_patterns_handler = async ({ project }) => {
  const project_id = await get_project_id(project);
 ...
 */
export const analysis_tests_handler = async ({ project }) => {
  const project_id = await get_project_id(project);
