...
const is_test_file = (filename, language) => {
  ...
  return patterns.some(function matches_test_pattern(pattern) {
...
const has_test_functions = (source, language) => {
  ...
  return patterns.some(function matches_test_function_pattern(pattern) {
...
const finalize_results = (results) => {
  results.test_functions.sort(function sort_by_assertions_desc(a, b) {
    return b.assertions - a.assertions;
  });
  ...
  results.mock_usage.sort(function sort_by_mock_count_desc(a, b) {
    return b.mock_count - a.mock_count;
  });
