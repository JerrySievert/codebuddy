...
const CONCURRENCY_PATTERNS = {
  javascript: {
    async_patterns: [
      ...
      {
        pattern: /\.finally\s*\(/,
        type: 'promise_finally',
        description: 'Promise .finally()'
      },
      {
        pattern: /\bPromise\.(all|race|allSettled|any)\s*\(/,
        type: 'promise_combinator',
        description: 'Promise combinator'
      },
      {
    ...
    thread_patterns: [
      ...
      },
      {
        ...
        type: 'worker_message',
        description: 'Worker message passing'
      },
      {
        pattern: /\bonmessage\s*=/,
        type: 'worker_handler',
        description: 'Worker message handler'
      }
    ],
    sync_patterns: [
      {
        pattern: /\bAtomics\.(wait|notify|waitAsync)\s*\(/,
        type: 'atomics',
        description: 'Atomics synchronization'
      },
      {
        pattern: /new\s+SharedArrayBuffer\s*\(/,
        type: 'shared_buffer',
    ...
    timer_patterns: [
      ...
      },
      {
        ...
        type: 'setInterval',
        description: 'setInterval callback'
      },
      {
        pattern: /\bsetImmediate\s*\(/,
        type: 'setImmediate',
        description: 'setImmediate callback'
      },
      {
        pattern: /\bprocess\.nextTick\s*\(/,
        type: 'nextTick',
        description: 'process.nextTick callback'
      }
    ]
  },
  ...
  typescript: {
    ...
    async_patterns: [
      ...
      },
      {
        pattern: /Promise</,
        type: 'promise_type',
        description: 'Promise type annotation'
      }
    ],
    thread_patterns: [
      {
  ...
  python: {
    async_patterns: [
      ...
      { pattern: /\bawait\s+/, type: 'await', description: 'Await expression' },
      {
        pattern: /\basyncio\./,
        type: 'asyncio',
        description: 'asyncio module usage'
      },
      {
        pattern: /\basync\s+for\b/,
        type: 'async_for',
        description: 'Async for loop'
      },
      {
        pattern: /\basync\s+with\b/,
        type: 'async_with',
    ...
    thread_patterns: [
      {
        pattern: /\bthreading\.Thread\b/,
        type: 'thread',
        description: 'Thread creation'
      },
      {
        pattern: /\bthreading\.Lock\b/,
        type: 'lock',
        description: 'Thread lock'
      },
      {
        pattern: /\bthreading\.RLock\b/,
        type: 'rlock',
        description: 'Reentrant lock'
      },
      {
        pattern: /\bthreading\.Semaphore\b/,
        type: 'semaphore',
        description: 'Semaphore'
      },
      {
        pattern: /\bthreading\.Event\b/,
        type: 'event',
        description: 'Thread event'
      },
      {
        pattern: /\bthreading\.Condition\b/,
        type: 'condition',
        description: 'Condition variable'
      },
      {
        pattern: /\bthreading\.Barrier\b/,
        type: 'barrier',
        description: 'Thread barrier'
      },
      {
        pattern: /\bmultiprocessing\.Process\b/,
        type: 'process',
        description: 'Multiprocessing process'
      },
      {
        pattern: /\bmultiprocessing\.Pool\b/,
        type: 'process_pool',
        description: 'Process pool'
      },
      {
        pattern: /\bconcurrent\.futures\./,
        type: 'futures',
    ...
    sync_patterns: [
      ...
      },
      {
        pattern: /\.release\s*\(/,
        type: 'lock_release',
        description: 'Lock release'
      },
      {
        pattern: /\bwith\s+.*lock/,
        type: 'lock_context',
        description: 'Lock context manager'
      }
    ],
    timer_patterns: []
  },
  ...
  java: {
    async_patterns: [
      ...
      },
      {
        pattern: /\.thenApply\s*\(/,
        type: 'then_apply',
        description: 'thenApply callback'
      },
      {
        pattern: /\.thenAccept\s*\(/,
        type: 'then_accept',
        description: 'thenAccept callback'
      },
      {
        pattern: /\.thenCompose\s*\(/,
        type: 'then_compose',
        description: 'thenCompose callback'
      },
    ...
    thread_patterns: [
      ...
      {
        pattern: /\bExecutorService\b/,
        type: 'executor',
        description: 'ExecutorService'
      },
      {
        pattern: /\bThreadPoolExecutor\b/,
        type: 'thread_pool',
        description: 'Thread pool executor'
      },
      {
        pattern: /\bExecutors\./,
        type: 'executors_factory',
        description: 'Executors factory'
      }
    ],
    sync_patterns: [
      {
        pattern: /\bsynchronized\s*\(/,
        type: 'synchronized_block',
        description: 'Synchronized block'
      },
      {
        pattern: /\bsynchronized\s+\w+\s*\(/,
        type: 'synchronized_method',
        description: 'Synchronized method'
      },
      {
        pattern: /\bReentrantLock\b/,
        type: 'reentrant_lock',
        description: 'ReentrantLock'
      },
      { pattern: /\bSemaphore\b/, type: 'semaphore', description: 'Semaphore' },
      {
        pattern: /\bCountDownLatch\b/,
        type: 'countdown_latch',
        description: 'CountDownLatch'
      },
      {
        pattern: /\bCyclicBarrier\b/,
        type: 'cyclic_barrier',
      ...
      },
      {
        pattern: /\bvolatile\s+/,
        type: 'volatile',
        description: 'Volatile field'
      },
      {
        pattern:
          /\bAtomicInteger\b|\bAtomicLong\b|\bAtomicBoolean\b|\bAtomicReference\b/,
        type: 'atomic',
    ...
    timer_patterns: [
      ...
      {
        pattern: /\bScheduledExecutorService\b/,
        type: 'scheduled_executor',
        description: 'Scheduled executor'
      }
    ]
  },
  ...
  csharp: {
    async_patterns: [
      ...
      {
        pattern: /\bTask\.WhenAll\s*\(/,
        type: 'task_when_all',
        description: 'Task.WhenAll'
      },
      {
        pattern: /\bTask\.WhenAny\s*\(/,
        type: 'task_when_any',
        description: 'Task.WhenAny'
      },
    ...
    thread_patterns: [
      ...
      {
        pattern: /\bParallel\.(For|ForEach|Invoke)\s*\(/,
        type: 'parallel',
    ...
    sync_patterns: [
      ...
      {
        pattern: /\bMonitor\.(Enter|Exit)\s*\(/,
        type: 'monitor',
        description: 'Monitor synchronization'
      },
      { pattern: /\bMutex\b/, type: 'mutex', description: 'Mutex' },
      {
        pattern: /\bSemaphore(Slim)?\b/,
        type: 'semaphore',
        description: 'Semaphore'
      },
      {
  ...
  go: {
    ...
    sync_patterns: [
      ...
      },
      {
        pattern: /\.RUnlock\s*\(/,
        type: 'rlock_release',
        description: 'Read lock release'
      }
    ],
    timer_patterns: [
      {
        pattern: /\btime\.After\s*\(/,
        type: 'timer_after',
        description: 'time.After'
      },
      {
        pattern: /\btime\.Tick\s*\(/,
        type: 'timer_tick',
        description: 'time.Tick'
      },
      {
        pattern: /\btime\.NewTimer\s*\(/,
        type: 'timer_new',
        description: 'time.NewTimer'
      }
    ]
  },
  ...
  rust: {
    async_patterns: [
      ...
      { pattern: /\btokio::/, type: 'tokio', description: 'Tokio runtime' },
      {
        pattern: /\basync_std::/,
        type: 'async_std',
        description: 'async-std runtime'
      },
      {
        pattern: /\basync\s+move\b/,
        type: 'async_move',
        description: 'Async move block'
      }
    ],
    thread_patterns: [
      {
        pattern: /\bstd::thread::spawn\b/,
        type: 'thread_spawn',
        description: 'Thread spawn'
      },
      {
        pattern: /\bthread::spawn\s*\(/,
        type: 'thread_spawn_call',
        description: 'Thread spawn call'
      },
      {
        pattern: /\brayon::/,
        type: 'rayon',
        description: 'Rayon parallel iterator'
      }
    ],
    sync_patterns: [
      ...
      { pattern: /\bmpsc::/, type: 'channel', description: 'MPSC channel' },
      {
        pattern: /\bcrossbeam::/,
        type: 'crossbeam',
        description: 'Crossbeam concurrency'
      },
      {
        pattern: /\.lock\s*\(\s*\)/,
        type: 'lock_acquire',
  ...
  cpp: {
    async_patterns: [
      {
        ...
        type: 'async',
        description: 'std::async'
      },
      { pattern: /\bstd::future</, type: 'future', description: 'std::future' },
      {
        pattern: /\bstd::promise</,
        type: 'promise',
        description: 'std::promise'
      },
      {
        pattern: /\bco_await\b/,
        type: 'co_await',
      ...
      {
        pattern: /\bco_return\b/,
        type: 'co_return',
        description: 'Coroutine return'
      },
      {
        pattern: /\bco_yield\b/,
        type: 'co_yield',
    ...
    sync_patterns: [
      ...
      {
        pattern: /\bstd::shared_mutex\b/,
        type: 'shared_mutex',
        description: 'std::shared_mutex'
      },
      {
...
const RACE_CONDITION_PATTERNS = [
  {
    ...
    check: (findings) => {
      ...
      const has_sync = findings.sync_patterns.length > 0;
  ...
  },
  {
    ...
    check: (findings) => {
      const acquires = findings.sync_patterns.filter(
        (p) => p.type === 'lock_acquire' || p.type === 'rlock_acquire'
      );
      const releases = findings.sync_patterns.filter(
        (p) => p.type === 'lock_release' || p.type === 'rlock_release'
      );
...
const analyze_function_concurrency = (fn) => {
  ...
  const patterns =
    CONCURRENCY_PATTERNS[language] || CONCURRENCY_PATTERNS.javascript;
  ...
  const check_patterns = (pattern_list, category) => {
  ...
  check_patterns(patterns.async_patterns, 'async_patterns');
  check_patterns(patterns.thread_patterns, 'thread_patterns');
  check_patterns(patterns.sync_patterns, 'sync_patterns');
  check_patterns(patterns.timer_patterns, 'timer_patterns');

  // Check for potential race conditions
  for (const race_pattern of RACE_CONDITION_PATTERNS) {
    if (race_pattern.check(findings)) {
      findings.warnings.push({
        id: race_pattern.id,
        description: race_pattern.description,
        severity: race_pattern.severity,
        function_id: fn.id,
        symbol: fn.symbol,
        filename: fn.filename,
        start_line: fn.start_line
...
const analyze_project_concurrency = async (project_id) => {
  ...
  for (const fn of functions) {
    ...
    if (has_concurrency) {
      ...
      results.by_file[fn.filename].async_count +=
        findings.async_patterns.length;
      results.by_file[fn.filename].thread_count +=
        findings.thread_patterns.length;
      results.by_file[fn.filename].sync_count += findings.sync_patterns.length;
      results.by_file[fn.filename].timer_count +=
        findings.timer_patterns.length;
      ...
      results.by_language[fn.language].async_count +=
        findings.async_patterns.length;
      results.by_language[fn.language].thread_count +=
        findings.thread_patterns.length;
      results.by_language[fn.language].sync_count +=
        findings.sync_patterns.length;
      results.by_language[fn.language].timer_count +=
        findings.timer_patterns.length;
    }
  }
  ...
  results.summary = {
    ...
    concurrency_percentage:
      functions.length > 0
        ? Math.round(
            (results.functions_with_concurrency.length / functions.length) *
              100 *
              10
          ) / 10
        : 0,
  ...
  const group_by_type = function group_patterns_by_type(patterns) {
    const grouped = {};
    ...
    return Object.values(grouped).sort(function sort_by_count_desc(a, b) {
      return b.count - a.count;
    });
  };

  results.async_patterns_grouped = group_by_type(results.async_patterns);
  results.thread_patterns_grouped = group_by_type(results.thread_patterns);
  results.sync_patterns_grouped = group_by_type(results.sync_patterns);
  results.timer_patterns_grouped = group_by_type(results.timer_patterns);
